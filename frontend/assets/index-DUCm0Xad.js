        ...
        <div class="form-grid">
          <label class="field">Memory Mode
            <select name="memory_mode">
              ${["full","indexed","context_only","none"].map(n=>`<option${a.memory_mode===n?" selected":""}>${n}</option>`).join("")}
            </select>
          </label>
